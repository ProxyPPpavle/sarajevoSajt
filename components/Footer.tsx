      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="flex items-center space-x-2 mb-8">
              <img src="/logo.png" alt="TBC Logo" className="w-12 h-12 object-contain" />
        ...
        <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-zinc-600 text-[10px] font-black uppercase tracking-[0.3em]">
          ...
          <div className="mt-6 md:mt-0 flex items-center space-x-2">
            ...
            <span className="text-orange-600 font-black">PAVLE PROLOVIC</span>
          </div>
        </div>
      </div>
    </footer>
